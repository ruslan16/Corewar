...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/13 05:23:27 by nsance            #+#    #+#             */
/*   Updated: 2021/01/08 23:26:57 by admin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	read_magic(const char *filename, int fd, t_champ *champ)
{
	...
	{
		ft_printf("corewar: error: %s: No magic number\n", filename);
		return (0);
	}
...
static int	read_name(const char *filename, int fd, t_champ *champ)
{
	...
	{
		ft_printf("corewar: error: %s: Bad name\n", filename);
		return (0);
	}
	buf[ret] = '\0';
	...
	{
		ft_printf("corewar: error: %s: Bad champ size\n", filename);
		return (0);
	}
	...
	{
		ft_printf("corewar: error: %s: Champ size (%u bytes) is not valid\n"
...
static int	read_comment(const char *filename, int fd, t_champ *champ)
{
	...
	{
		ft_printf("corewar: error: %s: Bad comment\n", filename);
		return (0);
	}
	buf[ret] = '\0';
...
static int	read_prog(const char *filename, int fd, t_champ *champ)
{
	...
	{
		ft_printf("corewar: error: %s: Bad champ code reading\n", filename);
		return (0);
	}
